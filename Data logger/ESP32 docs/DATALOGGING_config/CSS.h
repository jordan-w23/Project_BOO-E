...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>BOO-E Server</title>"); // NOTE: 1em = 16px
  ...
  webpage += F("ul{list-style-type:none;padding:0;border-radius:0em;overflow:hidden;background-color:#13afe8;font-size:1em;}");     //main display bar
  ...
  webpage += F("li a:hover{background-color:#0841c7;border-radius:0em;font-size:100%}");                                              //Hover background
  webpage += F("h1{color:white;border-radius:0em;font-size:1.5em;padding:0.2em 0.2em;background:#13afe8;}");
  ...
  webpage += F("</style></head><body><h1>Blue-Open-Ocean-Explorer Webserver</h1>");        //TITLE
  webpage += F("<ul>");
